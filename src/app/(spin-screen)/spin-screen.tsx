import { View, Image, ImageBackground, Animated, Easing, TouchableOpacity, Text } from 'react-native';import { SafeAreaView } from 'react-native-safe-area-context';
...
const SpinScreen = () => {
  ...
  <Animated.Image
      ...
      />
<Image source={require('~/assets/images/knob.png')} 
...
/>
      ...
      <TouchableOpacity
        ...
        disabled={spinning}
      >
        <Text className="text-black font-bold text-lg">{spinning ? 'Spinning...' : 'Spin Now'}</Text>
      </TouchableOpacity>
